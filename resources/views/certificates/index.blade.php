                                ...
                                <td class="px-6 py-4">
                                    <div class="flex justify-center items-center">
                                        <a href="{{ asset($certificado->certificado) }}" data-tts="up" aria-label="Descargar certificado"
                                            ...
                                            class="flex flex-row gap-3 items-center hover:border-purple-600 dark:hover:border-transparent justify-center font-medium hover:bg-purple-600 hover:p-4 p-4   rounded-md group dark:text-purple-500 dark:hover:text-white hover:text-white mr-6">
