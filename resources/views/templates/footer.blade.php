...
<footer class="bg-white  shadow sm:flex sm:items-center sm:justify-between p-2 sm:p-4 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2023-{{ $date->format('Y') }} <a href="https://fabriziodev.ar/" s class="hover:underline"
            target="_blank">Fabriziodev.ar</a>. Todos los derechos reservados.
    </p>
