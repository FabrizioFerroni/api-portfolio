        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('certificados') }}"
                    ...
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 group-active:text-gray-900 dark:group-hover:text-white dark:group-active:text-white {{ request()->is('certificados*') ? 'text-gray-900 dark:text-white' : '' }}"
            ...
            <li>
                <a href="#"
                    ...
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 group-active:text-gray-900 dark:group-hover:text-white dark:group-active:text-white"
