    ...
    <div>
        <div
            ...
            <div class="mb-6 flex items-center justify-between">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Trabajos</h1>
                <a href="{{ route('trabajos.create') }}" type="button"
                    ...
                    <tbody>
                        ...
                        class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                <th scope="row"
                                    ...
                                    {{ $trabajo->title }}</th>
                                <td class="px-4 py-3">{{ $trabajo->empresa }}</td>
                                <td class="px-4 py-3">
                                    {{ Str::limit($trabajo->descripcion, 25, '...') }}</td>
                                <td class="px-4 py-3">{{ $trabajo->duracion }}</td>
                                <td class="px-4 py-3">{{ $trabajo->fecha_desde_hasta }}</td>
                                <td class="px-4 py-3 ">{{ $trabajo->actual ? 'Si' : 'No' }}</td>
                                <td class="px-4 py-3  ">

                                    <div class="flex justify-center items-center">
                                        <a href="{{ route('trabajos.edit', $trabajo->id) }}" data-tts="up" aria-label="Editar"
                                        ...
                                        <button type="button" id="deleteModal-{{ $trabajo->id }}" data-tts="up" aria-label="Eliminar"
                            ...
                            {{-- Modal --}}
                            <div id="deleteModal-{{ $trabajo->id }}" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            <form action="{{ route('trabajos.destroy', $trabajo->id) }}" method="POST"
                                                ...
                                                <button data-modal-toggle="deleteModal-{{ $trabajo->id }}"
                                                    type="button"
                        ...
                        @empty
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 ">
                                <td class="text-center px-6 py-4" colspan="7">No hay trabajos
                                    registrados aún. Crea uno nuevo <a href="{{ route('trabajos.create') }}"
