...
<x-app-layout>
    <div>
        <div
            ...
            <div class="mb-6 flex items-center justify-between">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Editar testimonio
                </h1>

            </div>
            <div class="relative overflow-x-auto  sm:rounded-lg">
                {{-- aqui va el form --}}
                <form action="{{ route('testimonios.update', $testimonio->id) }}" method="POST" novalidate enctype="multipart/form-data">
                    @csrf
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 px-4">
                        <div>
                            ...
                            <input type="text" name="cliente" id="cliente" value="{{ old('cliente') ?? $testimonio->cliente }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="cargo" id="cargo" value="{{ old('cargo') ?? $testimonio->cargo }}"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="descripcion" name="descripcion" rows="8"
                                ...
                                placeholder="Descripción del testimonio">{{ old('descripcion') ?? $testimonio->descripcion }}</textarea>
                            @error('descripcion')
                                <div class="text-red-500 pt-1 pl-0">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="sm:col-span-2 ">
                            ...
                            <div class="flex flex-col justify-start items-start">
                                <img src="{{ asset($testimonio->imagen) }}"
    ...
    @section('scripts')
        <script>
            ...
            const defaultFile = "{{ asset($testimonio->imagen) }}";
