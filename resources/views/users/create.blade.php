        ...
        <div>
            <div
                ...
                <div class="mb-6 flex items-center justify-between">
                    <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Agregar nuevo usuario
                    </h1>
                        ...
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 px-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" value="{{ old('email') ?? '' }}"
                                    class="bg-gray-50 border border-gray-300 {{ $errors->has('email') ? 'dark:border-red-700 border-red-700' : '' }} text-gray-900 text-sm rounded-lg  focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
