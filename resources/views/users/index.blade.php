...
<li aria-current="page">
    <div class="flex items-center">
        ...
        <span class="ml-1 text-sm font-medium text-gray-900 md:ml-2 dark:text-white">Usuarios</span>
    </div>
</li>
@endsection
<x-app-layout>
    <div>
        <div
            ...
            <div class="mb-6 flex items-center justify-between">
                <h1 class="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Usuarios</h1>
                ...
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                    ...
                    <tbody id="user-table-body">
                        @forelse ($usuarios as $usuario)
                            <tr
                                ...
                                <td scope="row"
                                    ...
                                    <div class="pl-3" style="padding-left: 1rem;">
                                        ...
                                        <div class="font-normal text-gray-500">{{ $usuario->email }}</div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        @if ($usuario->email_verified_at !== null)
                                            <div class="h-2.5 w-2.5 rounded-full bg-green-500 mr-2" style="height: 0.625rem; width:0.625rem"></div> Activo
                                        @else
                                            <div class="h-2.5 w-2.5 rounded-full bg-red-500 mr-2" style="height: 0.625rem; width:0.625rem"></div> Inactivo
                                        @endif
                                    </div>
                                </td>
                                <td class="px-4 py-3  ">
                                    ...
                                    <div class="flex justify-center items-center">
                                        <a href="{{ route('usuarios.edit', $usuario->id) }}" data-tts="up" aria-label="Editar"
                                        ...
                                        <button type="button" id="userModal-button-{{ $usuario->id }}" data-tts="up" aria-label="Eliminar"
                                            data-modal-toggle="userModal-{{ $usuario->id }}"
                            ...
                            {{-- Modal --}}
                            <div id="userModal-{{ $usuario->id }}" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-center items-center space-x-4">
                                            <form action="{{ route('usuarios.destroy', $usuario->id) }}" method="POST" novalidate>
                                                @csrf
                                                <button type="submit"
                                                ...
                                                <button data-modal-toggle="userModal-{{ $usuario->id }}" type="button"
                        ...
                        @empty
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 ">
                                <td class="text-center px-6 py-4" colspan="7">No hay usuarios
                                    registrados aún. Crea uno nuevo <a href="#" class="text-blue-300">aquí</a>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
